...
class SelectionAgentState(TypedDict):
    ...
    specific_assets: Optional[str]  # User-specified assets for LLM parsing
...
def equity_selection_node(state: SelectionAgentState) -> SelectionAgentState:
    ...
    try:
        ...
        specific_assets = state["specific_assets"]
        ...
        equity_results = run_equity_selection(
            regions=regions,
            sectors=sectors,
            specific_assets=specific_assets,  # Pass user-specified assets for LLM parsing
...
def run_selection_agent(regions: Optional[List[str]] = None,
                       ...
                       filtered_weights: Optional[Dict[str, float]] = None,
                       specific_assets: Optional[str] = None) -> Dict[str, Any]:
    """
    ...
    Args:
        ...
        filtered_weights: Dictionary mapping ticker to weight
                         (e.g., {'SPY': 0.6, 'BND': 0.4})
        specific_assets: User-specified assets as string (e.g., "AAPL and TESLA")
